...
export default function Blogs(){
    ...
    let cards = "card w-1/2 bg-gradient-to-br from-primary to-secondary shadow-xl border-neutral border-2 scale-100 hover:opacity-100 hover:scale-105 hover:z-20 duration-300 hover:border-gray-400 hover:blur-0";
    return (

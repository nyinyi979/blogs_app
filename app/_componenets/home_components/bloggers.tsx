...
export default function Bloggers(){
  ...
  //Example bloggers in base route , all are styled with tailwind 
    ...
    let cards = "card md:w-1/2 w-5/12 bg-gradient-to-br from-primary to-secondary shadow-xl scale-95 border-neutral border-2 text-xs md:text-sm hover:blur-0 hover:z-20 hover:scale-100 hover:opacity-100 hover:border-primary duration-300";
